...
csp = secure.ContentSecurityPolicy().default_src("*").script_src("'unsafe-inline' https://cdn.jsdelivr.net").style_src("*").frame_ancestors("'none'")
...
@app.get("/api/messages/public", tags=["public"])
def public():
